...
abstract class Planta(val anioObtencionSemilla: Int, var altura: Float) {
  ...
  /**
   * Problema de cohesion, este metodo debería encontrarse en la clase parcela.
  * */
...
/**
 * Problema de (des)acoplamiento, debería implementarse una clase hija que maneje la soja transgenica.
 */
